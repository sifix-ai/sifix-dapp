                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-xs font-medium px-2 py-0.5 rounded-md bg-surface-elevated text-ink border border-hairline-strong shadow-sm">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-4 left-4 bg-surface-elevated text-ink px-3 py-2 rounded-lg text-sm font-medium backdrop-blur-sm sm:hidden border border-hairline-strong"
          >
            {hoveredLocation}
          </motion.div>
        )}
