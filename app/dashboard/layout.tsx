    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <div className="w-20 h-20 bg-gradient-0g rounded-2xl flex items-center justify-center mx-auto mb-6">
          ...
          <p className="text-white/60 mb-8 text-center">
            Please connect your wallet to access the SIFIX dashboard and protect your crypto assets on 0G Chain.
          </p>
          <div className="space-y-4">
            <ConnectButton />
          </div>
          <div className="mt-6 pt-6 border-t border-white/[0.08]">
            <p className="text-xs text-white/40 text-center mb-3">Supported Wallets</p>
            <div className="flex items-center justify-center gap-3">
              <div className="w-8 h-8 bg-white/[0.05] rounded-lg flex items-center justify-center text-white/40 text-xs">MM</div>
              <div className="w-8 h-8 bg-white/[0.05] rounded-lg flex items-center justify-center text-white/40 text-xs">CB</div>
              <div className="w-8 h-8 bg-white/[0.05] rounded-lg flex items-center justify-center text-white/40 text-xs">WC</div>
            </div>
          </div>
        </Card>
      </div>
